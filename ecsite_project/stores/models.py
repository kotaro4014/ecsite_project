...
class ProductTypes(models.Model):       #商品の種類を表すクラス
...
class Manufacturers(models.Model):      #生産者のクラス
    name = models.CharField(max_length=1000)
...
class ProductsManager(models.Manager):      #在庫数のクラス
...
class Products(models.Model):       #商品のクラス
    name = models.CharField(max_length=1000)
...
class ProductPictures(models.Model):        #商品画像のクラス
